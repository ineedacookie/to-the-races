...
ITEMS: tuple[dict[str, Any], ...] = (
    {
        ...
        "description": "Multiplies current speed by 1.58 for this race. Every dose stacks.",
        "icon": "⚡",
        "color": "#5ad1ff",
        "kind": ItemDefinition.Kind.SPEED_TONIC,
        "target": ItemDefinition.Target.RACER,
        "price_cents": 800,
        "effect_strength": 0.29,
        "sort_order": 10,
    },
    {
        ...
        "description": (
            "Makes the racer tougher, quicker to recover, and less prone to chaotic mistakes."
        ),
        "icon": "🛡",
        "color": "#e8e0c9",
    ...
    {
        "slug": "invincibility-tonic",
        "name": "Invincibility Tonic",
        "description": ("Protects the racer from fire and physical damage for the entire race."),
        "icon": "✨",
        "color": "#f8f2a0",
        "kind": ItemDefinition.Kind.INVINCIBILITY_TONIC,
        "target": ItemDefinition.Target.RACER,
        "price_cents": 8_000,
        "effect_strength": 1.0,
        "sort_order": 56,
    },
    {
        "slug": "berserk-potion",
        "name": "Berserk Potion",
        "description": "Knocks out the first racer they cross paths with this race.",
        "icon": "💢",
        "color": "#ff4050",
        "kind": ItemDefinition.Kind.BERSERK_TONIC,
        "target": ItemDefinition.Target.RACER,
        "price_cents": 6_400,
        "effect_strength": 1.0,
        "sort_order": 57,
